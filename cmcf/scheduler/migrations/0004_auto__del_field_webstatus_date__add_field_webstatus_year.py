...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'WebStatus.date'
        db.delete_column('scheduler_webstatus', 'date')

        # Adding field 'WebStatus.year'
        db.add_column('scheduler_webstatus', 'year', self.gf('django.db.models.fields.DateField')(default=datetime.date(2010, 9, 30)), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'WebStatus.date'
        db.add_column('scheduler_webstatus', 'date', self.gf('django.db.models.fields.DateField')(default=datetime.date(2010, 9, 30)), keep_default=False)

        # Deleting field 'WebStatus.year'
        db.delete_column('scheduler_webstatus', 'year')
