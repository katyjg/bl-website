...
tinyMCE.init({
    ...
    theme_advanced_buttons1: "formatselect,styleselect,|,bold,italic,underline,|,indent,bullist,numlist,blockquote,|,undo,redo,|,anchor,link,unlink,|,image,|,pasteword,|,grappelli_adv",
    theme_advanced_buttons2: "search,|,fullscreen,template,media,charmap,|,code,|,table,cleanup,grappelli_documentstructure",
