...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Adding field 'Photo.newfield'
        db.add_column('photologue_photo', 'newfield', self.gf('django.db.models.fields.CharField')(default=1, max_length=100, unique=True), keep_default=False)
