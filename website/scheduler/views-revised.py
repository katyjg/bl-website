...
WARNING = "This is a change to the current week's schedule. An update will be e-mailed to you and the USO %s at 10AM."
ERROR = "This change may result in confusion!  It is too last-minute for the USO to be notified in time to get a permit."
...
def edit_visit(request, id, model, form, template='wp-root.html'):
    ...
    if request.method == 'POST':
        ...
        form.error_message = ["help!  I'm stuck in here!"]
